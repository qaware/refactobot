...
class SequentialExpanderTest{
    ...
    fun testExpandRefactoringPlan(){
        ...
        val file1 = File(Paths.get("de/qaware/tools/bulkrename/test"), "TestDTO.java", FileType.JAVA)
        val file2 = File(Paths.get("de/qaware/tools/bulkrename/test"), "TestEntity.java", FileType.JAVA)
        ...
        val codebase = Codebase(rootPath = Paths.get("/home/tester/project/bulkrename/"),
